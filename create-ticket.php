...
$a=mysqli_query($con,"insert into ticket(ticket_id,email_id,subject,task_type,priority,ticket,status,posting_date)  values('$tid','$email','$subject','$tt','$priority','$ticket','$st','$pdate')");
if($a)
{
